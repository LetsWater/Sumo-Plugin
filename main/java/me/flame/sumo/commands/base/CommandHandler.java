package me.flame.sumo.commands.base;

import me.flame.sumo.Core;
import me.flame.sumo.commands.*;
import me.flame.sumo.utils.ChatUtils;
import me.flame.sumo.utils.IHandler;
...
public class CommandHandler implements IHandler, CommandExecutor, TabCompleter {
    ...
    public void enable(Core core) {
        ...
        core.getCommand("sumo").setExecutor(this);

        Stream.of(
                new HelpCommand(), new AboutCommand(), new ArenaCommand(), new ReloadCommand(), new SetSpawnCommand(), new RequestCommand(), new AcceptCommand()
